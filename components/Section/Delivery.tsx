...
const Delivery = () => {
  return (
    <section className="relative flex min-h-[110dvh] w-screen flex-col items-center overflow-hidden bg-secondary">
      ...
      {/* Main text content */}
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 py-16 text-center sm:py-20 md:pt-24">
        {/* Top half */}
