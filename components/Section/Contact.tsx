...
const Contact = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="contact"
      className="relative flex md:min-h-dvh w-screen flex-col items-center justify-center overflow-hidden bg-black"
    >
      {/* Left hand — bottom left */}
        ...
        <Image
          ...
          width={900}
          height={900}
          className="hidden lg:flex h-auto w-[1000px] object-cover absolute top-1/2 -translate-y-1/2 left-0"
        />
      ...
      <Image
        ...
        width={900}
        height={900}
        className="hidden lg:flex h-auto w-[1000px] object-cover absolute top-1/2 -translate-y-1/2 right-0"
      />
      ...
      <div className="relative z-10 flex w-full max-w-[700px] flex-col items-center px-6 py-20 text-center sm:px-10 md:py-28 lg:py-32">
        <h2 className="font-mendl-semibold text-[65px] leading-none text-white sm:text-[72px] md:text-[96px] lg:text-[120px] xl:text-[140px]">
          Stock
        </h2>
        <h2 className="font-mendl-semibold text-[65px] leading-none text-white sm:text-[72px] md:text-[96px] lg:text-[120px] xl:text-[140px]">
        ...
        <p className="mt-10 w-full md:w-2xl font-garamond-bd-narrow-ita text-white md:mt-14 lg:text-2xl">
